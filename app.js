...
var portfolioSerializer = require('./app_server/middleware/portfolio_serializer');

var app = express();
app.use(compression());

// This gets all of the data needed to fetch images for projects.
portfolioSerializer.serializePortfolio();
